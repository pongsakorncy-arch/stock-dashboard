    ...
    <main className="min-h-screen bg-[#0a0a0c] flex items-center justify-center">
      <div className="w-full max-w-sm px-6">
        <div className="text-center mb-10">
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-yellow-400 to-orange-500 flex items-center justify-center text-black font-black text-2xl mx-auto mb-4">
            T
          </div>
          <h1 className="text-2xl font-black text-white tracking-tight">TRUST YOUR OWN</h1>
        ...
        <p className="text-center text-xs text-zinc-700 mt-6">TRUST YOUR OWN · ไม่ใช่คำแนะนำการลงทุน</p>
      </div>
    </main>
  );
}
